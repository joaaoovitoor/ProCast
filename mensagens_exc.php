            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="mg_bt">
                        ...
                        <?php
                            if (isset($_POST['ext'])) {
                                $sqlex='delete from mensagem where excluido_env="V" AND id_enviar='.$con['id_usuario'].';';
                                mysqli_query($conexao,$sqlex);
                                $sqlex='delete from mensagem where excluido_rec="V" AND id_receber='.$con['id_usuario'].';';
                                mysqli_query($conexao,$sqlex);
                        ...
                        ?>
                                ...
                                <?php
                                    $sqlsel='select * from mensagem where (((id_receber="'.$con['id_usuario'].'") AND (excluido_rec="V")) AND ((id_receber="'.$con['id_usuario'].'") AND (favorito_rec="F"))) OR (((id_enviar="'.$con['id_usuario'].'") AND (excluido_env="V")) AND ((id_enviar="'.$con['id_usuario'].'") AND (favorito_env="F")) AND ((id_enviar="'.$con['id_usuario'].'") AND (rascunho="F")));';
                                    ...
                                    if(mysqli_num_rows($resul))
                                    {
                                        while ($con_msg=mysqli_fetch_array($resul))
                                        {
                                                    ...
                                                    <div class="panel bg_branco_w mg_bt">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="col-xs-offset-2 col-sm-offset-2 col-xs-6">
                                                               <a class="btn sem_bg borda_azul fonte_azul_claro mg_btn" href="mensagens_exc.php?fav_1='.$con_msg['id_mensagem'].'">Favoritar Mensagem <span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
                                                                <a class="btn sem_bg borda_azul fonte_azul_claro mg_btn" href="mensagens_exc.php?ex_1='.$con_msg['id_mensagem'].'">Apagar Mensagem <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                           ...
                                           '); 
                                            ...
                                            {
                                                $ex=$_GET['ex_1'];
                                                $sqlex='delete from mensagem where id_mensagem='.$ex.';';
                                                mysqli_query($conexao,$sqlex);
