...
else
{
	...
	if($con['categoria_usuario']==1)
	{
		if($tipoan==1)
		{
			$valor_cobrado = "9,90"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
			$dadosboleto["valor_unitario"] = "9,90";
		}
		elseif($tipoan==2)
		{
			$valor_cobrado = "19,90"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
			$dadosboleto["valor_unitario"] = "19,90";
		}
	}
	else
	{
		$valor_cobrado = "39,90"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
		$dadosboleto["valor_unitario"] = "39,90";
	}
