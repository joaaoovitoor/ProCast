...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 18-Nov-2017 às 02:26
...
-- Database: `dbprocast`
--
CREATE DATABASE IF NOT EXISTS `dbprocast` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dbprocast`;
...
CREATE TABLE IF NOT EXISTS `clube` (
  ...
  `logo_clube` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `contato` (
  ...
  KEY `fk_contato_usuario` (`id_usuario`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `noticia` (
  ...
  `id_categoria_noticia` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_noticia`),
  KEY `fk_categoria_noticia` (`id_categoria_noticia`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
