...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 04-Dez-2017 às 09:06
...
INSERT INTO `admin` (`id_admin`, `nome`, `sobrenome`, `senha`, `email`) VALUES
(1, 'Admin', 'Principal', 'UHJvY2FzdDIwMTch', 'admin@admin');
...
CREATE TABLE IF NOT EXISTS `agenda` (
  ...
  KEY `fk_usuario_agenda` (`id_usuario`)
...
CREATE TABLE IF NOT EXISTS `anunciante` (
  `dta_criacao_conta` datetime DEFAULT NULL,
  ...
  `cidade` int(2) NOT NULL,
  `senha` varchar(100) NOT NULL,
  `email` varchar(50) NOT NULL,
  `telefone` char(15) NOT NULL,
  PRIMARY KEY (`id_anunciante`),
  KEY `fk_estado_an` (`estado`),
  KEY `fk_cidade_an` (`cidade`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `anuncio` (
  ...
  `data_criacao_anuncio` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `status` char(1) NOT NULL,
  `id_anunciante` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_anuncio`),
  KEY `fk_anuncio_anunciante` (`id_anunciante`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `anuncio_jog`
--

DROP TABLE IF EXISTS `anuncio_jog`;
CREATE TABLE IF NOT EXISTS `anuncio_jog` (
  `id_anuncio` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario_an` int(11) NOT NULL,
  `data_criacao_anuncio` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `tipo` char(1) DEFAULT NULL,
  `status_pagamento` char(2) NOT NULL,
  PRIMARY KEY (`id_anuncio`),
  KEY `fk_usuario_an_jog` (`id_usuario_an`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `categoria_noticia` (
  ...
  `categoria_noticia` char(20) NOT NULL,
...
INSERT INTO `categoria_noticia` (`id_categoria_noticia`, `categoria_noticia`, `descri`) VALUES
(1, 'Jogos', 'Categoria que trata sobre jogos'),
(2, 'Torneios', 'Categoria que trata sobre torneios de LoL'),
(3, 'Mercado', 'Categoria que trata sobre mercado e-sports');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cat_contato`
--

DROP TABLE IF EXISTS `cat_contato`;
CREATE TABLE IF NOT EXISTS `cat_contato` (
  `id_cat_contato` int(11) NOT NULL AUTO_INCREMENT,
  `descricao` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id_cat_contato`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `cat_contato`
--

INSERT INTO `cat_contato` (`id_cat_contato`, `descricao`) VALUES
(1, 'Dicas'),
(2, 'Problemas'),
(3, 'Reclamações'),
(4, 'Propostas'),
...
CREATE TABLE IF NOT EXISTS `clube` (
  ...
  `logo_clube` varchar(100) DEFAULT NULL,
  `nome_clube` varchar(50) NOT NULL,
  `dta_criacao` date NOT NULL,
  `numero_jogadores` int(3) DEFAULT NULL,
  `descricao_clube` varchar(250) NOT NULL,
  `numero_vitorias_clube` varchar(4) DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_clube`),
  KEY `fk_usuario_clube` (`id_usuario`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `colocacao`
--
...
CREATE TABLE IF NOT EXISTS `colocacao` (
  ...
  `id_usuario` int(11) DEFAULT NULL,
  `colocacao` varchar(4) DEFAULT NULL,
  PRIMARY KEY (`id_colocacao`),
  KEY `fk_torneio_colocacao` (`id_torneio`),
  KEY `fk_usuario_colocacao` (`id_usuario`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `contato` (
  ...
  `elogio` char(1) DEFAULT NULL,
  `arq` char(1) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `convite` (
  ...
  KEY `fk_jogador_convite` (`id_jogador`),
  KEY `fk_investidor_convite` (`id_investidor`),
  KEY `fk_clube_convite` (`id_clube`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `foto` (
  ...
  `legenda_foto` varchar(300) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mensagem` (
  ...
  `anexo_ant` varchar(50) DEFAULT NULL,
  `mensagem` varchar(500) DEFAULT NULL,
  `favorito_env` varchar(11) DEFAULT NULL,
  `excluido_env` varchar(11) DEFAULT NULL,
  `rascunho` varchar(11) DEFAULT NULL,
  `favorito_rec` varchar(11) DEFAULT NULL,
  `excluido_rec` varchar(11) DEFAULT NULL,
  `solicitacao_env` varchar(11) DEFAULT NULL,
  `solicitacao_rec` varchar(11) DEFAULT NULL,
  `data` datetime DEFAULT NULL,
  `view` varchar(1) DEFAULT NULL,
  `id_enviar` int(11) NOT NULL,
  `id_receber` int(11) NOT NULL,
  PRIMARY KEY (`id_mensagem`),
  KEY `fk_usuario_enviar` (`id_enviar`),
  KEY `fk_usuario_receber` (`id_receber`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `pagamento` (
  ...
  `numero_boleto` varchar(60) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `nome_usuario_pag` varchar(50) NOT NULL,
  `tipo_pagamento` char(1) DEFAULT NULL,
  `tipo` char(1) DEFAULT NULL,
  `status_pagamento` char(2) DEFAULT '0',
  PRIMARY KEY (`id_pagamento`),
  KEY `fk_usuario_pagamento` (`id_usuario`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `pagamento_an`
--

DROP TABLE IF EXISTS `pagamento_an`;
CREATE TABLE IF NOT EXISTS `pagamento_an` (
  `id_pagamento` int(11) NOT NULL AUTO_INCREMENT,
  `dta_geracao` datetime NOT NULL,
  `valor_pagamento` varchar(10) NOT NULL,
  `numero_boleto` varchar(60) NOT NULL,
  ...
  `status_pagamento` char(2) DEFAULT 'F',
  PRIMARY KEY (`id_pagamento`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `tipo_denuncia` (`id_tipo`, `descricao_denuncia`) VALUES
(1, 'Informações falsas'),
(2, 'Vídeos de outra autoria'),
(3, 'Conteúdo inadequado'),
(4, 'Comportamento indevido');
...
CREATE TABLE IF NOT EXISTS `torneio` (
  ...
  `dta_inicio_torneio` datetime NOT NULL,
  `dta_termino_torneio` datetime NOT NULL,
  `colocacoes_torneio` varchar(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `id_nick` int(20) DEFAULT NULL,
  `foto_perfil` varchar(100) DEFAULT NULL,
  `funcao_1` int(11) DEFAULT NULL,
  `funcao_2` int(11) DEFAULT NULL,
  `senha` varchar(100) NOT NULL,
  `email` varchar(50) NOT NULL,
  ...
  KEY `fk_funcao_1` (`funcao_1`),
  KEY `fk_funcao_2` (`funcao_2`),
...
CREATE TABLE IF NOT EXISTS `video` (
  ...
  KEY `fk_usuario_video` (`id_usuario`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
COMMIT;
